package
{
	...
	public class VOCWordToYourMp3small extends MovieClip {
		...
		public function VOCWordToYourMp3small()
		{
			...
			this.wavbtn.addEventListener(MouseEvent.CLICK, onWavClick)
			...
			ExternalInterface.addCallback("get_dial_selected", receivedFromJavaScript);
		}
		...
		private function makeIntoMp3(wav)
		{
			...
			function mp3EncodeComplete(e: Event) : void 
			{
				...
				//statustxt2.appendText("Colócale un nombre (en el campo inferior) y presiona 'GUARDAR AUDIO', para subirlo a internet");
			}					
		}
		private function onWavClick(e:MouseEvent)
		{
			if(wavbtn.currentFrame==1)
			{
				...
				var urlRequest:URLRequest = new URLRequest("http://kka.to/kkatoo/apps/add_tree_record_audio");
				urlRequest.method = URLRequestMethod.POST;
				urlRequest.contentType='multipart/form-data; boundary=' + UploadPostHelper.getBoundary();
				urlRequest.data = UploadPostHelper.getPostData(nombre_txt.text + ".mp3",sba, {nombre:nombre_txt.text, arbol:arbol});
		...
		{
			statustxt.text = "Terminó de reproducirse";		
		}
