...
//TEMPLATES 
var TEMPLATE_TEXTSPEACH = '<tr class="content_resume content_resume_text_{id}"><td>{name_field}</td><td class="center"><a href="javascript:;" class="telefono" title="Asignar Contenido" data-content="{id}_text"></a><a href="javascript:;" class="item-edit-ico" data-id="{id}" data-tipo="{tipo}"></a><a href="javascript:;" class="item-view-ico" data-id="{id}" data-tipo="{tipo}"></a><a href="#" class="item-delete-ico" data-id="{id}" data-tipo="{tipo}"></a></td></tr><tr class="content_view content_view_text_{id}"><td colspan="3"><h4>'+$line_nombre+': </h4><p class="name_field">{name_field}</p><h4>'+$line_the_message+'</h4><p class="message">{message}</p><h4>'+$line_voicena+'</h4><p class="voice" data-voice-id={voice_id}>{voice}</p></td></tr>';

var TEMPLATE_AUDIO = '<tr class="content_resume content_resume_audio_{id}"><td>{name_field}</td><td class="center"><a href="javascript:;" class="telefono" title="Asignar Contenido" data-content="{id}_audio"></a><a href="javascript:;" class="item-edit-ico" data-id="{id}" data-tipo="audio"></a><a href="javascript:;" class="item-view-ico" data-id="{id}" data-tipo="audio"></a><a href="javascript:;" class="item-delete-ico" data-id="{id}" data-tipo="audio"></a></td></tr><tr class="content_view content_view_audio_{id}" style="display: none;"><td colspan="3"><h4>'+$line_nombre+'</h4><p class="name_field">{name_field}</p><audio id="player2" src="{url_audio}" type="audio/mp3" controls></audio></td>';
...
function add_text_speach_to_list(data){
	...
	if(exists_resume.length > 0){
		exists_resume.children('td:nth-child(1)').text(data.name);
