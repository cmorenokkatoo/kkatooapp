	...
	<div id="wrapper">
        ...
        <h4>Los campos marcados con * son obligatorios.</h4>
				...
				<div class="row section-content">
					...
					<div class="span6 left-column">
						<div class="control-group">
							...
							<div class="control-group">
								<label class="control-label"><strong>*Nombra tu Aplicación:</strong></label>
								<div class="controls">
							...
							<div class="control-group">
								<label class="control-label"><strong>*Diseña tu imagen:</strong></label>
								<div class="controls">
							...
							<div class="control-group">
								<label class="control-label"><strong>Enlaza tu video (opcional):</strong></label>
								<div class="controls">
							...
							<div class="control-group">
								<label class="control-label"><strong>*Sube la imagen para el Marketplace:</strong></label>
								<div class="controls">
			...
			<section id="advanced-customize">
				...
				<div class="row">
					...
					<div class="span6 left-column">
						<div class="control-group">
							...
							<div class="controls">
                                ...
                                <div class="control-group">
							<label class="control-label"><strong>* Privacidad de la aplicación:</strong></label>
							<div class="controls">
					...
					<div class="span6 right-column columa-derecha-puntos">
						<div class="control-group">
                                	<br>
                                	<label class="control-label"><strong>Añadir Campos Dinámicos (Opcional):</strong></label>
			...
			<div id="btn_container">
				 <button class="btn btn-warning btn-large btn-save-app">GUARDAR Y ENVIAR APLICACIÓN PARA APROBACIÓN</button>
			</div>
		</div><!-- #container -->
	</div><!-- #wrapper -->
